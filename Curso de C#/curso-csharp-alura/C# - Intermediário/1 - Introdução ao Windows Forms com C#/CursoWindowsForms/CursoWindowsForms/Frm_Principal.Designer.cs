namespace CursoWindowsForms
{
  partial class Frm_Principal
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Btn_ValidaSenha.Text = "Válida Senha";
      ...
      this.Btn_DemonstracaoKey.TabIndex = 1;
      ...
      this.Btn_ValidaCPF2.Text = "Válida CPF 2";
      ...
      this.Btn_ValidaCPF.TabIndex = 6;
      this.Btn_ValidaCPF.Text = "Válida CPF";
